...
export const getResources = (state: IAppState) =>
  state.resources;
...
export const getResourceData = (state: IAppState, resource: ResourceTagType) =>
  getResource(state, resource).data;
...
export const getResourcePageIds = (state: IAppState, resource: ResourceTagType, pageNumber: number): string[] =>
...
export const getResourcePageData = <T extends ResourceType>(state: IAppState, resource: ResourceTagType, pageNumber: number): T[] =>
  getResourcePageIds(state, resource, pageNumber)
    .map(id => getDataById(state, resource, id)) as T[];
